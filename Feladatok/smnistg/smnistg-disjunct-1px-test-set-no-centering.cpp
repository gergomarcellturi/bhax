// Semantic MNIST (Experiment 1b, no-centering, disjunct test set)
...
//
// g++ smnistg-disjunct-test-set-no-centering.cpp -o smnistg -lpng
// ./smnistg
//
...
// 
// g++ smnistg-disjunct-1px-test-set-no-centering.cpp -o smnistg -lpng
// ./smnistg
...
// 1px        for ( int k {-1}; k < 2; ++k )
// 1px            for ( int l {-1}; l < 2; ++l ) {
// 1px
// 1px                img.set_pixel ( x[j]+k, y[j]+l, png::rgb_pixel ( 0, 0, 0 ) );
